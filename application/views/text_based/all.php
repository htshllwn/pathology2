                ...
                <?php foreach ($tb_tests as $tb_test): ?>
                    <tr>    
                        ...
                        <td align="right">
                            ...
                            <a href="<?php echo base_url().'text_based/edit_text_based/'.$tb_test->test_slug ?>" class="btn btn-default"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
