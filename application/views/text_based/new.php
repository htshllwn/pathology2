<div id="container" class="container">
	...
	<?php echo form_open('text_based/new_text_based'); ?>
	    ...
	    <div class="form-group">
	    	...
	    	<div id="colHead1" class="col-md-12">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/new-text-based.js"></script>
