...
--
-- Host: localhost
-- Generation Time: Feb 04, 2018 at 04:49 PM
...
--
-- Table structure for table `anc-profile`
--

CREATE TABLE `anc-profile` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `anc-profile`
--

INSERT INTO `anc-profile` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'HB%', 'hb', 'TEST', NULL),
(2, 'RBS', 'rbs', 'TEST', NULL),
(3, 'BLOOD-GROUP', 'blood-group', 'TEST', NULL),
(4, 'RH (D) TYPE', 'rh-d-type', 'TEST', NULL),
(5, 'VDRL', 'vdrl', 'TITLE', 'Venereal disease research laboratory (VDRL) test is a nontreponemal test, used for screening of syphilis due to its simplicity, sensitivity and low cost. Prozone phenomenon and biological false positive (BFP) reaction are two shortcomings of this test. Quantitative estimation of VDRL is essential in treatment evaluation. CSF VDRL test is very specific for neurosyphilis though its sensitivity is low. Interpretation of VDRL in HIV infection is incompletely understood.'),
(6, 'RESULT', 'result', 'TEST', NULL),
(7, 'HIV-1,11', 'hiv-111', 'TEST', NULL),
(8, 'HBsAg', 'hbsag', 'TEST', NULL),
(9, 'BT 1-3 MINIT', 'bt-1-3-minit', 'TEST', NULL),
(10, 'CT 2-7 MINIT', 'ct-2-7-minit', 'TEST', NULL);
...
INSERT INTO `blood` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'BLOOD-GROUP', 'blood-group', 'TEST', NULL);
...
(3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, NULL, '2018-02-02 14:26:33'),
(4, 5, 1011, 122, 222, 222, 22, 2, 2, 2, 2, 22, 2, 2, NULL, 22, 2, 2, 22, NULL, 2, 22, 2, NULL, '2018-02-03 12:17:41');

-- --------------------------------------------------------

--
-- Table structure for table `dengue-profile`
--

CREATE TABLE `dengue-profile` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `dengue-profile`
--

INSERT INTO `dengue-profile` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'DENGUE NSI ANTIGEN', 'dengue-nsi-antigen', 'TEST', 'METHOD: IMMUNOCHROMATOGRAPHY'),
(2, 'DENGUE IgM ANTIBODY', 'dengue-igm-antibody', 'TEST', 'SENSITIVITY: DENGUE NSI Ag 92%, DENGUE IgG IgM Ab 99.4% <br>SPECIFICITY: DENGUE NSI Ag 98.4% DENGUE IgG IgM AB 93.0%'),
(3, 'DENGUE IgG ANTIBODY', 'dengue-igg-antibody', 'TEST', 'LIMITATION : THIS IS ONLY A SCREENING TEST THEREFORE , ISOLATION OF VIIRUS ,DETECTION IN FIXED TISSUE RT-PCR AND SEROLOGICAL TEST LIVE .HAEMAGGLUTINATION INHIBITION TEST MORE SPECIFIC ALTERNATIVE DIAGNOSTIC METHOD MUST BE USED IN ORDER TO OBTAIN A CONFIRMATION OF DENGUE VIRUS INFECTION.');
...
(5, 3, 1212, 22, 223, 22, 3, 33, '2018-02-02 13:19:36');
...
(2, 3, 1, 1, 1, NULL, NULL, NULL, '2018-02-02 13:51:06');

-- --------------------------------------------------------

--
-- Table structure for table `malaria-antigen`
--

CREATE TABLE `malaria-antigen` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `malaria-antigen`
--

INSERT INTO `malaria-antigen` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(2, 'RESULT', 'result', 'TEST', 'Over 100 types of Plasmodium parasite can infect a variety of species. They replicate at different rates, and this affects how quickly the symptoms escalate, and the severity of the disease.  Five types of Plasmodium parasite can infect humans. They are found in different parts of the world. Some cause a more severe type of malaria than others.</li>\r\n\r\n<li>\r\nThe new malaria parasites are then released back into the bloodstream, where they infect red blood cells and multiply further. Some malaria parasites remain in the liver and are not released until later, resulting in recurrence.</li>');
...
(5, 'MR. VIJAY KUMAR', 34, 'M', '8120011545', 'DR. N.PARMAR', 200, '2018-02-02 14:30:36');

-- --------------------------------------------------------

--
-- Table structure for table `peripheral-smear-examination`
--

CREATE TABLE `peripheral-smear-examination` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `peripheral-smear-examination`
--

INSERT INTO `peripheral-smear-examination` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(2, ' RBC\'s SERIES', 'rbcs-series', 'TEST', 'A blood smear is a blood test used to look for abnormalities in blood cells.</li>\r\n<li>\r\nred cells, which carry oxygen throughout your body'),
(3, 'WBC\'s SERIES', 'wbcs-series', 'TEST', 'white cells, which help your body fight infections and other inflammatory diseases'),
(4, 'PLATELETS', 'platelets', 'TEST', 'platelets, which are important for blood clotting'),
(5, 'PARASITE', 'parasite', 'TEST', NULL),
(6, 'COMMENTS', 'comments', 'TEST', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `prothrombin-time`
--

CREATE TABLE `prothrombin-time` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `prothrombin-time`
--

INSERT INTO `prothrombin-time` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(2, 'CONTROL TIME ', 'control-time', 'TEST', 'Causes of prolonged PT include the following:  Warfarin use Vitamin K deficiency from malnutrition, biliary obstruction, malabsorption syndromes, or use of antibiotics Liver disease, due to diminished synthesis of clotting factors Deficiency or presence of an inhibitor to factors VII, X, II/prothrombin, V, or fibrinogen Disseminated intravascular coagulopathy (DIC)</li>\r\n<li>\r\nFibrinogen abnormality (eg, hypofibrinogenemia, afibrinogenemia, dysfibrinogenemia) After bolus administration of heparin (PT may be transiently elevated) Massive blood transfusion due to dilution of plasma clotting proteins Hypothermia, as it causes inhibition of a series of enzymatic reactions of the coagulation cascade'),
(3, 'PATIENT TIME ', 'patient-time', 'TEST', NULL),
(4, 'PROTHROMBIN RATIO', 'prothrombin-ratio', 'TEST', NULL),
(5, 'PROTHROMBIN INDEX', 'prothrombin-index', 'TEST', NULL),
(6, 'I.S.I. ', 'isi', 'TEST', NULL),
(7, 'I.N.R. ', 'inr', 'TEST', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ps-for-maleria`
--

CREATE TABLE `ps-for-maleria` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `ps-for-maleria`
--

INSERT INTO `ps-for-maleria` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'RESULT', 'result', 'TEST', 'Blood smears are required for diagnosing malarial parasites. The parasites\' number in blood may fluctuate at times and hence, if they are not found during initial smears and the general practitioner still thinks that the patient is affected by malaria, more samples of blood may be needed to test.');
...
(3, 3, 20, 20, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2018-02-02 13:30:55'),
(4, 5, 28.2, 12.3, 0.88, NULL, 3.21, NULL, NULL, NULL, 9.2, '2018-02-02 14:32:15');

-- --------------------------------------------------------

--
-- Table structure for table `semen-analysis`
--

CREATE TABLE `semen-analysis` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `semen-analysis`
--

INSERT INTO `semen-analysis` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'PHYSICAL EXAMINATION', 'physical-examination', 'TITLE', 'Minimum requirments for fertility:'),
(2, 'VOLUME', 'volume', 'TEST', 'Concentration 20 millions/ml.'),
(3, 'COLOUR', 'colour', 'TEST', 'Motility 30% progressive.'),
(4, 'VISCOSITY', 'viscosity', 'TEST', 'Morphology 30% normal.'),
(5, 'ODOUR', 'odour', 'TEST', NULL),
(6, 'LIQUIFICATION', 'liquification', 'TEST', 'Minimum specimen volume for microscope analysis is 0.1ml.'),
(7, 'CHEMICAL EXAMINATION', 'chemical-examination', 'TITLE', 'Highly viscous specimens may affect accuracy of concentration & motility results.'),
(8, 'REACTION', 'reaction', 'TEST', 'A minimum of two analysis,perferably one month apart is recommended to correct for cycalic variations in sperm concentration.'),
(9, 'FRUCTOSE', 'fructose', 'TEST', 'Specimen collectioin should occur with in window  of 48-72 hrs abstinence to maximize average concentration of live cells.'),
(10, 'MICROSCOPE EXAMINATION', 'microscope-examination', 'TITLE', NULL),
(11, 'SPERM CONCENTRATION', 'sperm-concentration', 'TEST', NULL),
(12, 'SPERM COUNT (TOTAL)', 'sperm-count-total', 'TEST', NULL),
(13, 'MOTILITY', 'motility', 'TITLE', NULL),
(14, 'PROGRESSIVE', 'progressive', 'TEST', NULL),
(15, 'NON PROGRESSIVE', 'non-progressive', 'TEST', NULL),
(16, 'NON MOTILE ', 'non-motile', 'TEST', NULL),
(17, 'MORPHOLOGY', 'morphology', 'TITLE', NULL),
(18, 'NORMAL ', 'normal', 'TEST', NULL),
(19, 'ABNORMAL', 'abnormal', 'TEST', NULL),
(20, 'CELLULAR ELEMENTS (/hpf)', 'cellular-elements-hpf', 'TITLE', NULL),
(21, 'IMMATURE GERM CELLS', 'immature-germ-cells', 'TEST', NULL),
(22, 'ROUND CELLS', 'round-cells', 'TEST', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `stool-analysis`
--

CREATE TABLE `stool-analysis` (
  `id` int(11) NOT NULL,
  `col_name` varchar(255) NOT NULL,
  `col_slug` varchar(255) NOT NULL,
  `cat` varchar(255) NOT NULL,
...
--
-- Dumping data for table `stool-analysis`
--

INSERT INTO `stool-analysis` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'PHYSICAL EXAMINATION', 'physical-examination', 'TITLE', 'A stool analysis is a series of tests done on a stool (feces) sample to help diagnose certain conditions affecting the digestive tract. These conditions can include infection (such as from parasites, viruses, or bacteria), poor nutrient absorption, or cancer.'),
(2, 'COLOUR', 'colour', 'TEST', NULL),
(3, 'CONSISTENCY ', 'consistency', 'TEST', NULL),
(4, 'REACTION', 'reaction', 'TEST', NULL),
(5, 'MUCUS', 'mucus', 'TEST', NULL),
(6, 'BLOOD', 'blood', 'TEST', NULL),
(7, 'MICROSCOPIC  EXAMINATION', 'microscopic-examination-ova', 'TITLE', 'Laboratory analysis includes microscopic examination, chemical tests, and microbiologic tests.'),
(8, 'OVA', 'ova', 'TEST', NULL),
(9, 'CYSTS', 'cysts', 'TEST', NULL),
(10, 'PUS CELLS', 'pus-cells', 'TEST', NULL),
(11, 'R.B.C.', 'rbc', 'TEST', NULL),
(12, 'FAT GLUCOS ', 'fat-glucos', 'TITLE', NULL),
(13, 'BACTERIA ', 'bacteria', 'TITLE', NULL);
...
(12, 'PERIPHERAL SMEAR EXAMINATION', 'peripheral-smear-examination'),
(13, 'SEMEN ANALYSIS ', 'semen-analysis'),
(14, 'MALARIA ANTIGEN', 'malaria-antigen'),
(15, 'STOOL ANALYSIS', 'stool-analysis'),
(18, 'PROTHROMBIN TIME', 'prothrombin-time'),
(19, 'DENGUE PROFILE', 'dengue-profile'),
(21, 'VDRL', 'vdrl'),
(22, 'PS FOR MALARIA', 'ps-for-maleria'),
(23, 'A.N.C. PROFILE', 'anc-profile'),
(24, 'BLOOD ', 'blood');
...
INSERT INTO `vdrl` (`id`, `col_name`, `col_slug`, `cat`, `interpretations`) VALUES
(1, 'RESULT', 'result', 'TEST', 'Venereal disease research laboratory (VDRL) test is a nontreponemal test, used for screening of syphilis due to its simplicity, sensitivity and low cost. Prozone phenomenon and biological false positive (BFP) reaction are two shortcomings of this test. Quantitative estimation of VDRL is essential in treatment evaluation. CSF VDRL test is very specific for neurosyphilis though its sensitivity is low. Interpretation of VDRL in HIV infection is incompletely understood.');
...
--
-- Indexes for table `anc-profile`
--
ALTER TABLE `anc-profile`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `dengue-profile`
--
ALTER TABLE `dengue-profile`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `malaria-antigen`
--
ALTER TABLE `malaria-antigen`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `peripheral-smear-examination`
--
ALTER TABLE `peripheral-smear-examination`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `prothrombin-time`
--
ALTER TABLE `prothrombin-time`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ps-for-maleria`
--
ALTER TABLE `ps-for-maleria`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `semen-analysis`
--
ALTER TABLE `semen-analysis`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `stool-analysis`
--
ALTER TABLE `stool-analysis`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `anc-profile`
--
ALTER TABLE `anc-profile`
...
--
-- AUTO_INCREMENT for table `dengue-profile`
--
ALTER TABLE `dengue-profile`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `liver-profile-details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `malaria-antigen`
--
ALTER TABLE `malaria-antigen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `patients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `peripheral-smear-examination`
--
ALTER TABLE `peripheral-smear-examination`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `prothrombin-time`
--
ALTER TABLE `prothrombin-time`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `ps-for-maleria`
--
ALTER TABLE `ps-for-maleria`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `renal-profile-details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `semen-analysis`
--
ALTER TABLE `semen-analysis`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `stool-analysis`
--
ALTER TABLE `stool-analysis`
